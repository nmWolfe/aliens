...
class AlienInvasion:
    ...
    def _update_bullets(self):
        ...
        self.bullets.update()
        # Get rid of bullets that have disppeared
    ...
    def _create_fleet(self):
        ...
        # Create an alien and keep adding aliens until there's no space.
        # Spacing between aliens is one aliens width and one aliens height
        alien = Alien(self)
        alien_width, alien_height = alien.rect.size
        # Check for space and add aliens
    ...
    def _update_screen(self):
        ...
        for bullet in self.bullets.sprites():
            # Can use draw_bullet or blitme method
            bullet.blitme()
        self.ship.blitme()
